    ...
    public partial class SeedUpdatedUsers : DbMigration
    {
        public override void Up()
        {
            Sql(@"
                ...
                INSERT INTO [dbo].[AspNetUsers] ([Id], [Email], [EmailConfirmed], [PasswordHash], [SecurityStamp], [PhoneNumber], [PhoneNumberConfirmed], [TwoFactorEnabled], [LockoutEndDateUtc], [LockoutEnabled], [AccessFailedCount], [UserName], [IdentityNumber]) VALUES (N'e5a63721-c1e2-4047-b987-9cd617718958', N'adminForMoviesOnly@vrs.com', 0, N'AIQHUrMeQFihj6MjK5rUePx5yQi3N+A9YIozx8oo/9OJKKLdlxSZ0BzvKaJ3aWL2VQ==', N'df5e66a5-0e4c-4bf1-a737-7b1546dee56d', NULL, 0, 0, NULL, 1, 0, N'adminForMoviesOnly@vrs.com', 0)
        ...
        {
            Sql(@"
                DELETE FROM [dbo].[AspNetRoles] WHERE [Id] = N'7602eeef-319a-4eae-aece-7e334c6da148' AND [Name] =  N'CanManageMovies';
                DELETE FROM [dbo].[AspNetRoles] WHERE [Id] = N'27283c18-2d38-4076-bbdf-dacdb42116a0' AND [Name] =  N'CanManageMoviesAndCustomers';
                
                DELETE FROM [dbo].[AspNetUsers] WHERE [Email] = N'admin@vrs.com';
                DELETE FROM [dbo].[AspNetUsers] WHERE [Email] = N'Pracownik1!@gmail.com';
                DELETE FROM [dbo].[AspNetUsers] WHERE [Email] = N'adminForMoviesOnly@vrs.com';
                
                DELETE FROM [dbo].[AspNetUserRoles] WHERE [UserId] = N'be3e811c-e1ab-4a23-aba7-2f1e3038e999';
                DELETE FROM [dbo].[AspNetUserRoles] WHERE [UserId] = N'e5a63721-c1e2-4047-b987-9cd617718958';
                ");
        }
    }
}
